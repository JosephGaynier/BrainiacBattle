...
{
    [DbContext(typeof(BraniacBattleContext))]
    partial class BraniacBattleContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BraniacBattle.Models.AccountGameStatistics", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.Accounts", b =>
                {
                    b.Property<int>("AccountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BraniacBattle.Models.AccountsBadges", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.Badges", b =>
                {
                    b.Property<int>("BadgeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BraniacBattle.Models.Benefits", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.Categories", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BraniacBattle.Models.Games", b =>
                {
                    b.Property<int>("GameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BraniacBattle.Models.MultiplayerResult", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.Results", b =>
                {
            ...
            modelBuilder.Entity("BraniacBattle.Models.AccountGameStatistics", b =>
                {
                    b.HasOne("BraniacBattle.Models.Accounts", "Account")
                        .WithMany("AccountGameStatistics")
                        .HasForeignKey("AccountId")
                        .HasConstraintName("FK_AccountGameStatistics_Accounts")
                        .IsRequired();

                    b.HasOne("BraniacBattle.Models.Games", "Game")
                        .WithMany("AccountGameStatistics")
            ...
            modelBuilder.Entity("BraniacBattle.Models.AccountsBadges", b =>
                {
                    ...
                    b.HasOne("BraniacBattle.Models.Badges", "Badge")
                        .WithMany("AccountsBadges")
            ...
            modelBuilder.Entity("BraniacBattle.Models.Benefits", b =>
                {
                    b.HasOne("BraniacBattle.Models.Categories", "Category")
                        .WithMany("Benefits")
            ...
            modelBuilder.Entity("BraniacBattle.Models.Results", b =>
                {
                    ...
                    b.HasOne("BraniacBattle.Models.MultiplayerResult", "MultiplayerResult")
                        .WithMany("Results")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BraniacBattle.Models.ApplicationUser", null)
                        .WithMany()
