...
{
    public partial class BraniacBattleContext : DbContext
    {
        public BraniacBattleContext()
        {
        }

        public BraniacBattleContext(DbContextOptions<BraniacBattleContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Name=BraniacBattleDB");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.AccountGameStaticId);
